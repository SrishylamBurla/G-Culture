  ...
  return (
    ...
    >
      ...
      <div ref={searchRef}>
        ...
        <div
          className={`fixed top-0 right-0 w-full h-screen bg-black/90 text-white z-[10000] transform transition-transform duration-500 ${
            menuOpen ? "translate-x-0" : "translate-x-full"
          }`}
        >
          {/* Nav Links */}
          <nav className="flex flex-col items-center justify-center space-y-4 h-screen text-xl font-light">
            {[
