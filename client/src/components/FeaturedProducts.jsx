        ...
        <div className="max-w-[1400px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
            {[...Array(4)].map((_, i) => (
              <div
                key={i}
                className="animate-pulse bg-white/10 rounded-xl h-80"
              />
            ))}
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
          {featuredProducts.map((product, i) => (
            <motion.div
              ...
              className="group relative bg-white/5 backdrop-blur-md rounded-xl overflow-hidden border border-white/10 shadow-xl"
            >
              ...
              <Link
                ...
                className="absolute inset-0 opacity-0 group-hover:opacity-100 flex items-center justify-center bg-black/40 backdrop-blur-sm text-white text-lg font-semibold transition"
              >
                View Product
              </Link>
